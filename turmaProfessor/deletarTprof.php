		...
		<p>
			<?php
				...
				$mysqli = new mysqli('localhost', 'root', '', 'crud');
                 ...
                 $sql = "select * from turmaprofessor where codigo = $codigo";
                 $result = $mysqli -> query($sql);
				 $linha = $result -> fetch_assoc();
				 	echo"Codigo: <input type='text' name='codigo' value='$linha[codigo]'/></label><br/>";
				 	echo"codProfessor: <input type='text' name='codProfessor' value='$linha[codProfessor]'/></label><br/>";
					 echo"codTurma: <input type='text' name='codTurma' value='$linha[codTurma]'/></label><br/>";
					echo("<form method='POST' action='excluirTprof.php'>
